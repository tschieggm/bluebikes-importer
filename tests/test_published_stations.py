...
def test_published_stations_from_csvs(published_stations_dir):
    ...
    expected_mappings = {
        'Station ID': ['K32015', 'A32000', 'A32019', 'A32019'],
        'Name': ['1200 Beacon St', 'Fan Pier', '175 N Harvard St', '175 N Harvard St'],
        'Latitude': [42.34414899, 42.35328743, 42.363796, 42.363796],
        'Longitude': [-71.11467361, -71.04438901, -71.129164, -71.129164],
        'Municipality': ['Brookline', 'Boston', 'Boston', 'Boston'],
        'Public': [True, None, True, True], '# of Docks': [15, 15, 18, 18],
        'File': ['current_bluebikes_stations.csv',
